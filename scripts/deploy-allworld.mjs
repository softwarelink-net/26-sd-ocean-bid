...
/**
 * Upload dist/ to:
 *   1) R2 26-sd-ocean-bid-assets  (project bucket)
 *   2) R2 allworld-sites/26-sd-ocean-bid/  (shared Allworld host)
...
const siteId = process.argv[2] || '26-sd-ocean-bid'
const projectBucket = '26-sd-ocean-bid-assets'
